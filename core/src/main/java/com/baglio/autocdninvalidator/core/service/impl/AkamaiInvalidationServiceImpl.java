...
public class AkamaiInvalidationServiceImpl implements CdnInvalidationService {
  ...
  public void activate(final Config config) {
    ...
    if (this.isEnabled) {
      ...
      this.unprocessedAkamaiUrl =
          "https://" + config.hostname() + "/ccu/v3/invalidate/" + SERVICE_NAME_PLACEHOLDER + "/" + config.network();
    }
  }
   ...
   * {@inheritDoc}
   *
   * @see <a href="https://techdocs.akamai.com/purge-cache/reference/delete-tag">Official Akamai documentation</a>
   */
  @Override
  public boolean invalidateByTag(final Set<String> tags) {
   ...
   * {@inheritDoc}
   *
   * @see <a href="https://techdocs.akamai.com/purge-cache/reference/delete-cpcode">Official Akamai documentation</a>
   */
  @Override
  public boolean invalidateByCode(final Set<String> codes) {
   ...
   * {@inheritDoc}
   *
   * @see <a href="https://techdocs.akamai.com/purge-cache/reference/delete-url">Official Akamai documentation</a>
   */
  @Override
  public boolean invalidateByURLs(final Set<String> urls) {
  ...
  @ObjectClassDefinition(name = "Auto CDN Invalidator - Akamai Purge API Settings", description = "")
